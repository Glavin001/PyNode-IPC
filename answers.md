...
2.
(2 pts) Describe (in your opinion) the best computer language for developing the following programs. Please state some sort of reason why you chose that language.
